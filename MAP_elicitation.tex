...
In all four specifications, participants ask on average for 0.687 more dark blue sectors (yielding a high payoff) in Good compared to Uniform to be willing to spin the selected wheel ($p$-value $<$ 0.001 in all specifications).
