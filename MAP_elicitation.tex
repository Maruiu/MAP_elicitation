...
For expected utility maximisers, the MAP should be independent of their belief about the actual probability of fair sharing.
...
\begin{figure}[h!]
	...
	\caption{Mean MAPs by treatment and sequence}
	\label{fig:MeanMAPs}
\end{figure}
...
Since the sequence of events and the information participants faced up to that point in the two treatments had been identical, this difference cannot be a treatment effect, nor an order effect.
